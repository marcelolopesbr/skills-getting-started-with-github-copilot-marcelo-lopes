...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and improve technical skills in soccer matches",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["lucas@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Develop shooting, dribbling, and defensive skills in basketball",
    ...
    "Science Olympiad": {
        "description": "Solve scientific challenges and prepare for competitions in STEM",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
